// ======================================================
// Textos del Lore en español (datos, sin lógica): lo que se edita para
// cambiar la historia. Los pinta js/lore.js.
// Hay una copia traducida por idioma (lore.en.js, lore.pt.js) con la misma
// estructura: si añades, quitas o reordenas pases aquí, haz lo mismo allí
// (tests/i18n.test.js avisa si no coinciden).
// ======================================================
